      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="credit_balance" mb="4" isInvalid={!!formik.errors?.credit_balance}>
              <FormLabel>Credit Balance</FormLabel>
              <NumberInput
                name="credit_balance"
                value={formik.values?.credit_balance}
                onChange={(valueString, valueNumber) =>
                  formik.setFieldValue('credit_balance', Number.isNaN(valueNumber) ? 0 : valueNumber)
                }
              >
                <NumberInputField />
                <NumberInputStepper>
              ...
              {formik.errors.credit_balance && <FormErrorMessage>{formik.errors?.credit_balance}</FormErrorMessage>}
            </FormControl>
