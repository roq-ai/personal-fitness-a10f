...
import { getCreditTransactionById } from 'apiSdk/credit-transactions';
...
function CreditTransactionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('credit_transaction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/credit-transactions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
